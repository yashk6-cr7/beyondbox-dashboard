...
function calcBadges(books, skillAverages, booksCompleted, xp, level) {
  ...
  return [
    ...
    { id:'well_rounded',      emoji:'🌈', title:'Well Rounded',      category:'Balance',     desc:'All skills growing evenly!',                    hint:'All skills within 1 point of each other',      unlocked: booksCompleted >= 1 && skillVals.length >= 6 && (maxS - minS) <= 1.0},
